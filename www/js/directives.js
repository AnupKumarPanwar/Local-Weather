    ...
    compile: function(element, attr) {
      return function($scope, $element, $attr) {
        ...
        $scope.$watch('current', function(current) {
          ...
          // console.log("cuee" + JSON.stringify(current.currently.icon));


          // if(current.currently.icon in WEATHER_ICONS) {
          //     $scope.currentIcon=WEATHER_ICONS[current.currently.icon];            
          // } else {
